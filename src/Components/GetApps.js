...
const GetApps = () => {
    return (
        <section className="dark:bg-gray-800 dark:text-gray-50 bg-gray-400 m-2 border rounded-xl">
            <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                <div className="flex flex-col justify-center lg:text-left">
                    <p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-400">Want to connect us anywhere</p>
                    <h1 className="py-2 text-3xl font-medium leading-tight title-font">Get Our Apps</h1>
                </div>
